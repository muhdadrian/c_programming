...
// If you find you use sales tax rate that may change, use #define to set it in one place  
...
int main () {
    ...
    // vars for the number of tires purchased, price, a before-tax total, and a total cost with tax
    ...
    scanf(" $%f", &tirePrice); // the $ sign is the culprit here
